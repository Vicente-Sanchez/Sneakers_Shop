...
@NamedQueries({
    ...
    , @NamedQuery(name = "Usuario.buscar", query = "SELECT u FROM Usuario u WHERE u.usu = :usu and u.pasword = :pasword")
...
public class Usuario implements Serializable {
    ...
    public Usuario(Integer id, String nombre, String usu, String pasword, int nivelUsuario, int status) {
        this.id = id;
        this.nombre = nombre;
        this.usu = usu;
